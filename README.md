# HoneyGRUB – Info Product and Events Website
...
<img src="img/HoneyGRUB.gif" width="300">

## UX

#### Goal

To provide a medium for users to navigate with ease, efficiently finding the information they require regarding the relevant theme; that being honey, and to convince website visitors that they should become followers/customers of the service.
...
- Honey is the core element of the project, so a bespoke colour scheme has been developed to embody the website theme without clashing aesthetically. This entailed the following:

  - > #000000 colour description: Black.
...
- Being as the website is based on a comfort food product a casual script typeface selection intended for use in informal documents was applied; thus, adding a comfortable tone to the displayed text content.
...
- [Google Fonts](https://fonts.google.com/ "Google Fonts Official Site")
  ...
  - 'Walter Turncoat', cursive and 'Schoolbell', cursive fonts were applied across the entire website
...
Because the website utilises a ‘single-scrolling-page’ design, all code or content is contained within just one document (index.html).
...
- Audio Controls – which are optional, and I have chosen to leave out could be added to increase the user’s ability to control more variables.

- Animated icons – for transitions to connect between two visual states.
